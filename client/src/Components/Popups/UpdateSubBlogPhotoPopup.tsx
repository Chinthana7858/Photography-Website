...
function UpdateSubBlogPhotoPopup(props: { SubblogId: string}) {
      ...
      if (selectedImage) {
        try {
          ...
          const response = await axios.put(
            `http://localhost:8080/api/v1/blogSubTopic/blogPhoto/${props.SubblogId}`,
            formData,
            {
              headers: {
...
export default UpdateSubBlogPhotoPopup;
